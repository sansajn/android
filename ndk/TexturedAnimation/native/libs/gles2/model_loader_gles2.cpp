...
{
	std::clog << "create_texture_mesh_properties(tex_name:" << tex_name << ")" << std::endl;
	...
	std::clog << "  diffuse texture loaded '" << tex_path.string() << "'" << std::endl;
	...
	if (fs::exists(tex_path))
	{
		...
		std::clog << "  normal texture loaded '" << tex_path.string() << "'" << std::endl;
	}
	...
	if (fs::exists(tex_path))
	{
		...
		std::clog << "  height texture loaded '" << tex_path.string() << "'" << std::endl;
	}
