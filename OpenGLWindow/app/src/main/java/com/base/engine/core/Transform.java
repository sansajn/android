...
public class Transform {
	...
	public void rotate(Vector3f axis, float angle) {rot = new Quaternion(axis, angle).mul(rot).normalized();}
	...
	public Matrix4f getTransformation() {
		Matrix4f T = new Matrix4f().initTranslation(pos.getX(), pos.getY(), pos.getZ());
		Matrix4f R = rot.toRotationMatrix();
		Matrix4f S = new Matrix4f().initScale(scale.getX(), scale.getY(), scale.getZ());
	...
	public void setPos(Vector3f t) {pos = t;}
	public void setRot(Quaternion r) {rot = r;}
	public void setScale(Vector3f s) {scale = s;}
