...
public class Quaternion {
	...
	public Quaternion(Vector3f axis, float angle) {
		float radHalf = angle/2;
		float sinHalfAngle = (float)Math.sin(radHalf);
		float cosHalfAngle = (float)Math.cos(radHalf);
	...
	public Quaternion sub(Quaternion r) {return new Quaternion(x-r.x, y-r.y, z-r.z, w-r.w);}
	...
	// normal linear interpolation (lerpFactor je z intervalu <0,1>)
