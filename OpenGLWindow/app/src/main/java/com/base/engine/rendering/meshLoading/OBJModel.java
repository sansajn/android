...
public class OBJModel {
	public OBJModel(String fileName) {
		...
		try {
			BufferedReader meshReader = new BufferedReader(
				new InputStreamReader(Android.getAssets().open("models/" + fileName)));
	...
	public IndexedModel toIndexdModel() {
