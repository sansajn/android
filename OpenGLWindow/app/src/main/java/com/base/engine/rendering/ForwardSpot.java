...
public class ForwardSpot extends Shader {
	...
	private ForwardSpot() {
		...
		addVertexShaderFromFile("forward_spot_vertex.glsl");
		addFragmentShaderFromFile("forward_spot_fragment.glsl");
		compileShader();
	...
	public void setUniformSpotLight(String uniformName, SpotLight spotLight) {
		...
		setUniformf(uniformName + ".cutoff", spotLight.getCuttof());
	}
